                    ...
                    <div className="flex flex-col sm:flex-row gap-6 sm:items-start">
                        ...
                        <div className="flex-1 flex flex-col gap-3">
                            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {tenantType === 'store' && (
                                        <Chip
                                            size="sm"
                                            className="font-bold border border-orange-500/20 bg-orange-500/10 text-orange-600 shadow-sm rounded-full"
                                        >
                                    ...
                                    {(tenant as any).verified && (
                                        <Chip
                                            size="sm"
                                            className="font-bold border border-blue-500/20 bg-blue-500/10 text-blue-500 shadow-sm px-2 rounded-full"
                                        >
                                            <Chip.Label className="flex items-center gap-1">
                            ...
                            <div className="flex flex-wrap items-center gap-4 text-sm text-[var(--muted)] font-medium">
                                {(tenant as any).game_name && (
                                    <span className="flex items-center gap-1.5 bg-violet-500/10 text-violet-500 px-2.5 py-1 rounded-full border border-violet-500/20 shadow-sm font-bold">
                                ...
                                {tenant.is_public && (
                                    <span className="flex items-center gap-1.5 bg-emerald-500/10 text-emerald-600 px-2.5 py-1 rounded-full border border-emerald-500/20">
                        ...
                        {tenantType === 'store' && (
                            <Tabs.Panel id="reviews">
                                <div className="flex flex-col gap-6 pt-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    ...
                                    <div className="flex flex-col items-center justify-center py-20 px-4 bg-[var(--surface)] border border-[var(--border)] rounded-3xl shadow-sm text-center">
                                        <div className="size-16 bg-gradient-to-tr from-amber-500/10 to-orange-500/20 rounded-full flex items-center justify-center text-3xl mb-4 border border-orange-500/20 shadow-inner">
                                            💬
                                        </div>
