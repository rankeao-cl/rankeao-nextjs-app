            ...
            <div className="flex items-center gap-2">
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <Popover>
                    <Popover.Trigger
                      className="relative flex items-center justify-center p-0 min-w-8 min-h-8 text-[var(--muted)] cursor-pointer hover:bg-black/5 rounded-md transition-colors"
                    >
                      <Badge.Anchor>
                  ...
                  {/* Create Menu Mobile / Desktop */}
                  <Dropdown>
                    <Dropdown.Trigger
                      className="flex items-center justify-center min-w-8 min-h-8 rounded-full shadow-brand-sm bg-primary text-white cursor-pointer hover:opacity-80 transition-opacity"
                      aria-label="Crear"
                    >
                      <Plus className="size-4 font-bold" />
                    </Dropdown.Trigger>
                    <Dropdown.Popover>
                      <Dropdown.Menu aria-label="Opciones de creación">
                        <Dropdown.Item id="post">
                          <div className="flex items-center gap-2">
                            <Person className="size-4" />
                            <span>Crear Post</span>
                          </div>
                        </Dropdown.Item>
                        <Dropdown.Item id="deck">
                          <div className="flex items-center gap-2">
                            <SquareDashed className="size-4" />
                            <span>Publicar Mazo</span>
                          </div>
                        </Dropdown.Item>
                        <Dropdown.Item id="sale">
                          <div className="flex items-center gap-2">
                  ...
                  {/* Avatar dropdown (Hidden on mobile since Perfil is in bottom nav) */}
                  <div className="hidden md:flex ml-1">
                    <Dropdown>
                      <Dropdown.Trigger className="rounded-full cursor-pointer flex border-none outline-none">
                        <Avatar size="sm">
                          <Avatar.Image
                            alt="Avatar"
                      ...
                      <Dropdown.Popover>
                        ...
                        <Dropdown.Menu>
                          <Dropdown.Item
                            id="profile"
                            onPress={() => {
                              window.location.href = "/perfil/me";
                            }}
